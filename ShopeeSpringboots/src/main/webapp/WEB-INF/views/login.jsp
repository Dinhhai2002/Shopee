			...
			<form action="login" method="post" class="authForm">
				<div class="authForm__body">
					<div class="authForm__header">
						...
						<a href="signup" class="authForm__switch-btn"> Đăng
							Ký </a>
					</div>
					<div class="authForm__form">
						...
						<div class="authForm__group">
							<input id="pass" value="${password}"name="password" type="password" class="authForm__input_password" placeholder="Nhập mật khẩu" required>
				...
				<div class="authForm__social">
					 <a
						href="https://accounts.google.com/o/oauth2/auth?scope=email%20profile%20openid&redirect_uri=http://localhost:8092/loginGoogle&response_type=code
                        &client_id=559752196823-9e2hgg255v2v8hn776r7d9pj5gmstbtd.apps.googleusercontent.com&approval_prompt=force"
