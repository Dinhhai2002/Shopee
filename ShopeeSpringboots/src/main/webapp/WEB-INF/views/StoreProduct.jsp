								...
								<tbody>
									<c:forEach items="${listO}" var="o">
										<tr style="margin: 8px 0;">
											...
											<input type="hidden" value="${o.orderstatus.id}"  id="orderStatus${o.id}"  /> 
											<c:if test="${s==1}">
													<td><button id="orderStatus" onclick="editOrder(${o.id})" value="${o.id}">hủy đơn</button></td>
                                                ...
                                                <ul class="navbarItem__user-list-detail">
                                                    <li class="navbarItem__user-item">
                                                        <a href="#" class="navbarItem__user-link">
                                                            Tên shop: ${o.shop.shopName}
                                                        </a>
                                                    </li>
                                                    <li class="navbarItem__user-item">
                                                        <a href="#" class="navbarItem__user-link">
                                                            Địa chỉ shop: ${o.shop.shopAddress}
                                                        </a>
                                                    </li>
                                                    <li class="navbarItem__user-item">
                                                        <a href="#" class="navbarItem__user-link">
