...
<body>
	...
	let cateLabels=[],cateInfo=[],ProductLabels=[],ProductInfo=[],ProductMonthLabels=[],ProductMonthInfo=[],ProductShopLabels=[],ProductShopInfo=[]
	...
	<c:forEach items="${listS}" var="o">
	ProductShopLabels.push('${o[0]}')
	ProductShopInfo.push(${o[1]})
	</c:forEach>
		window.onload=function()
		{
			...
			ProductShopChart("myShopChart",ProductShopLabels,ProductShopInfo)
		}
	</script>
