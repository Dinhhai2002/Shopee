                    ...
                    <table>
                        ...
                        <c:forEach items="${listShop}" var="o">
                            <tr>
                                ...
                                <td>
                                <img style="width: 150px; height: 150px; object-fit: contain;" src="${o.shopImage}" alt=" ${o.shopName}">						
										
									
								</td>
                                <td class="customerEdit">
                                    <a href="" onclick="editShopModal(${o.shopId})" class="edit btn-link" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="" >
                    ...
                    <div class="modal-body">					
                        	<input id="editIdShop" name="id" value="" hidden="">
                            <div class="form-group">
                            <label>Tên danh mục:</label> <input id="editNameShop" type="text" class="form-control"
                            value="category" name="name" />
                            </div>
                            <div class="form-group">
                            <label>Image</label>
                            <input name="imageCategory" id="ImageShop"type="text" class="form-control" required>
                              <img id="editImageShop" class="img-responsive" width="100px" src=""
                            alt="">
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" onclick="updateShop()" class="btn btn-default">Edit</button>
