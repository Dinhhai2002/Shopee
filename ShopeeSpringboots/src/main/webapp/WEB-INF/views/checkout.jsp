            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="right border">
                        ...
                        <div class="row item">
                            <div class="col-4 align-self-center"><img class="img-fluid" src="${c.productImage}"></div>
                            <div class="col-8">
     <!--  tien-->              <div class="row"><b>Đơn giá:<fmt:formatNumber type="number" pattern="#,###" value="${c.price}"></fmt:formatNumber>vnđ </b></div>
                                <div class="row text-muted">${c.productName}</div>
                                <div class="row">Sô lượng:${c.quantity}</div>
                                 <div class="row">Thành tiền:<fmt:formatNumber type="number" pattern="#,###" value="${c.price * c.quantity}"></fmt:formatNumber>vnđ</div>
                            </div>
                        </div>
                         </c:forEach>
                        ...
                        <div class="row lower">
                           <!--  <div class="col text-left">Thành tiền</div> -->
                            ...
                            <div class="col text-right"><fmt:formatNumber type="number" pattern="#,###" value="${cartStats.amount}"></fmt:formatNumber>vnđ</div>
                        </div>
                        <%-- <div class="row lower">
                       ...
                       <!--  <input onclick="pay()" type="submit" value="Đặt hàng" /> -->
                         <a href="#" onclick="pay()" class="btn">Đặt hàng</a> 
                        </form>
