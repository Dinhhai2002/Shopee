            ...
            <form action="signup" method="post" class="authForm">
                <div class="authForm__body">
                    <div class="authForm__header">
                        ...
                        <a href="login" class="authForm__switch-btn">
                            Đăng Nhập
                        </a>
                    </div>
                    <div class="authForm__form">
                        ...
                        <div class="authForm__group">
                            <input id="username"name="username" type="text" class="authForm__input" placeholder="Nhập tên người dùng" pattern="[A-Za-z0-9]{5,}" title="không đúng" >
                            <small></small>
                        </div>
                        <div class="authForm__group">
                        ...
                        <div class="authForm__group">
                            <input id="pass"name="password" type="password" class="authForm__input" placeholder="Nhập mật khẩu" pattern="[A-Za-z0-9]{5,}" title="không đúng"  >
                            <small></small>
                        </div>
                        <div class="authForm__group">
