                ...
                <div class="row sm-gutter">
                    <div class="col l-12 m-12 c-12">
                        ...
                        <li class="navbar__item border-none">
                            <a href="/login" class="navbar__item-link medium-text">
                                Đăng Nhập
                            </a>
                        </li> 
                    </c:if>
                                <li class="navbar__item border-none">
                                    <div class="navbar__item-user">
                                       ...
                                       <c:if test="${sessionScope.acc!=null}">
                                    	...
                                    	<img src="<c:url value="/images/noname.jpg"/>" alt="" class="navbarItem__user-img">
                                    	</c:if> 
                                    	</c:if>                         
                                    ...
                                    <c:if test="${not empty sessionScope.acc.UImage}">
                                        ...
                                        <ul class="navbarItem__user-list">
                                            <li class="navbarItem__user-item">
                                                <a href="/myAccount" class="navbarItem__user-link">
                                                    Tài Khoản Của Tôi
                                                </a>
                                            </li>
                                            <li class="navbarItem__user-item">
                                                <a href="/orderBuy" class="navbarItem__user-link">
                                                    Đơn Mua
                                                </a>
                                            </li>
                                            <li class="navbarItem__user-item">
                                                <a href="/logout" class="navbarItem__user-link">
                                                    Đăng Xuất
                                                </a>
                                            </li>
                                        </ul>
                        ...
                        <div class="header-with-search">
                            <div class="header-with-search__logo">
                                <a href="/home" class="header-with-search__link hide-on-mb-tb">
                                ...
                                <div id="mySidepanel" class="sidepanel">
                                    <a href="javascript:void(0)" class="closebtn" onclick="closeNav()">×</a>
                                     ...
                                     <c:if test="${sessionScope.acc!=null}">
                                    <a href="/myAccount">Tài khoản cá nhân</a>
                                    <a href="/orderBuy">Đơn mua</a>
                            ...
                            <form action="<c:url value="/product/pagenated" />" class="header-with-search__search-section">
                                <div class="searchbar">
                                    <div class="searchbar__main">
                                        <div class="searchbar-input">
                                            ...
                                            <input value="${txtS}" name="name" type="text" class="searchbar-input__input"
                            ...
                            <div class="header-with-search__cart-wrap">
                             <a href="/cart">   <div class="header-with-search__cart-btn hide-on-mb-tb">
                                    
                           <i class='header-with-search__cart-icon bx bx-cart-alt' ></i>
                           
                                    <div id="cartCounter"class="header-with-search__cart-number">${cartCounter}</div>
