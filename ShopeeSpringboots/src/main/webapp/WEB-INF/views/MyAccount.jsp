				...
				<div class="shop-category-on-mb-tb hide-on-pc">
                    ...
                    <ul class="row no-gutters shop-category-on-mb-tb-list">
                        <li class="col m-3 c-4 shop-category-on-mb-tb-item">
                            <a href="/myAccount" class="shop-category-on-mb-tb-item-link">
                        ...
                        <li  class="col m-3 c-4 shop-category-on-mb-tb-item">
                            <a href="/changePassword" class="shop-category-on-mb-tb-item-link">
                        ...
                        <li class="col m-3 c-4 shop-category-on-mb-tb-item">
                            <a href="/orderBuy" class="shop-category-on-mb-tb-item-link">
					...
					<div class="col l-2 lo-2 hide-on-mb-tb">
						<div class="category-list">
							...
							<ul class="category-list__list">
								...
								<li class="category-list__item "><a href="/myAccount"
								...
								<c:if test="${empty sessionScope.acc.UPassword}">
								<li hidden class="category-list__item "><a href="/changePassword"
								...
								<c:if test="${not empty sessionScope.acc.UPassword}">
								<li class="category-list__item "><a href="/changePassword"
									class="category-list__item-link  ">
										<i class="category-list__item-icon fas fa-caret-right"></i>
										Đổi mật khẩu
								</a></li>
								</c:if>
								<li class="category-list__item "><a href="/orderBuy"
									class="category-list__item-link ">
										<i class="category-list__item-icon fas fa-caret-right"></i>
										Đơn mua
								</a></li>
