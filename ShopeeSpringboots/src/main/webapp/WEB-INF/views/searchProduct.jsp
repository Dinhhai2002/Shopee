						...
						<ul class="row no-gutters search-item-result-on-mb-tb-list">
							<c:forEach items="${listCC}" var="o">
								...
								<li class="col m-3 c-3 search-item-result-on-mb-tb-item">
									<!-- border-primary color-primary --> <a
									href="/product/id=${o.CId}"
									class="search-item-result-on-mb-tb-link ${cid==o.CId?"category-list__item-link-highlight":""}  ">
										<span class="search-item-result-on-mb-tb-text">
											${o.CName} </span> <span class="separate"></span>
								</a>
								</li>
							</c:forEach>
						...
						<ul class="row no-gutters search-item-result-on-mb-tb-list">
							<li class="col m-3 c-3 search-item-result-on-mb-tb-item"><a
								...
								class="search-item-result-on-mb-tb-link border-primary color-primary">
									<span class="search-item-result-on-mb-tb-text"> Tất cả
										sản phẩm </span> <span class="separate"></span>
							</a></li>
							<li class="col m-3 c-3 search-item-result-on-mb-tb-item"><a
							...
							<li class="col c-3 m-3 search-item-result-on-mb-tb-item"></li>
						</ul>
					</div>
							...
							<div class="col l-12 lo-12 hide-on-mb-tb">
								<div class="sort-bar">
									...
									<div class="sort-bar-by-options">
										<button
											onclick="location.href='/Shopee/product?index=0&page=1'"
											class="btn btn--primary">Tất cả sản phẩm</button>
										...
										<form style="margin-left:20px;" action="">
											<label for="size">size</label> <select name="size" id="size"
												...
												<option ${productPage.size==7? 'selected': ''} value="7">7</option>
											...
											<div class="search-item-result__item-price-wrap">
												...
												<div class="search-item-result__item-price-saleoff">
													<span> <fmt:formatNumber type="number"
															pattern="#,###" value="${o.PPrice}"></fmt:formatNumber>đ
													</span>
						...
						<c:if test="${productPage.totalPages>0}">
							<ul class="pagination hide-on-mb">
								<li class="pagination-item"><a
									href="<c:url value="/product/searchpagenated?name=${name}&size=${productPage.size}&page=${1}" />"
								...
								<c:forEach items="${pageNumbers}" var="pageNumber">
									<c:if test="${productPage.totalPages >1}">
										<li class="pagination-item"><a
											href="<c:url value="/product/searchpagenated?name=${name}&size=${productPage.size}&page=${pageNumber}"/> "
								...
								<li class="pagination-item"><a
									href="<c:url value="/product/searchpagenated?name=${name}&size=${productPage.size}&page=${productPage.totalPages}"/> "
