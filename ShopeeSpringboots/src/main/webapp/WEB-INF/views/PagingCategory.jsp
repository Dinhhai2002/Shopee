					...
					<div class="col l-2 lo-2 hide-on-mb-tb">
						<div class="category-list">
							<h2 class="category-list__title">
								<a href="/product/pagenated" class="category-list__title-link"> <i
						...
						<c:if test="${productPage.totalPages>0}">
							<ul class="pagination hide-on-mb">
								<li class="pagination-item"><a
									href="<c:url value="/product/pagenated/cateId=${cateId}?size=${productPage.size}&page=${1}" />"
								...
								<c:forEach items="${pageNumbers}" var="pageNumber">
									<c:if test="${productPage.totalPages >1}">
										<li class="pagination-item"><a
											href="<c:url value="/product/pagenated/cateId=${cateId}?size=${productPage.size}&page=${pageNumber}"/> "
								...
								<li class="pagination-item"><a
									href="<c:url value="/product/pagenated/cateId=${cateId}?size=${productPage.size}&page=${productPage.totalPages}"/> "
